[DEAR claude text between [] like this is a sign that this is a note for you, not part of the output. Please do not include it in the final answer. It is just to help you understand the context and what I want to say. Thank you!]
[the current version uses words in a very un technical and unformal way fix it]
...
[change workstation with laptop ; workstatoin is so diffficlt to understand , do not make this paragraph comlicated just explain how windows
 can't do the job for my project and I switched to linux ubuntu 24.04 LTS and how one of the main reasons is because the deployment server use ubuntu 24.04 
 and I wanted to have the same environment for development and deployment]
...
[brother !!! not your everyday application server ! this is so much bad phrasing for a report , it feels like a blog post]
[please read middleware/core/configs there is clear steps on how to configure the wildfly server just don't go tooo deep in technical details just give an overview of the process
 of how we configured the wildfly server]
...
\begin{table}[H]
    ...
    \label{tab:techstack}
    \begin{tabular}{ll}
        [do not hallucinate if you need some information just ask me and I will provide it to you , do not make up information that is not in the report or that I didn't provide you with]

        \hline
        \textbf{Layer} & \textbf{Technology} \\
        \hline
        Application server   & Wildfly Preview 39.0.0.Final   \\
...
[I want to add a note that in my dev environment I have a local IAM module even though in deployment the IAM is already deployed and I just connect to it
and I want to state that in order for me to learn and  give value to my work that I received an old version of the IAM module
that had many errors that I was resonsible to fix in the goal of me understanding how the IAM works in depth and not jsut operate on it
as a black box ]
...
\texttt{core}
 is packaged as a JAR and is listed as a compile-time dependency of both
